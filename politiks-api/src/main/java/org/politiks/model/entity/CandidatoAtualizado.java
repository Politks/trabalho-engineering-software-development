...
public class CandidatoAtualizado extends PanacheEntity {
    ...
    // Construtores
    public CandidatoAtualizado() {
    }

    public CandidatoAtualizado(String nome, String cpf, Long partidoId) {
        this.nome = nome;
        this.cpf = cpf;
        this.partidoId = partidoId;
    }

    public CandidatoAtualizado(String nome, String cpf, String dataNascimento, String biografia, 
